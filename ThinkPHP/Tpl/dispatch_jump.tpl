...
.system-message{ position:absolute; padding: 30% 20%; }
...
<script type="text/javascript">
	Showbo.Msg.alert(<?php echo ($message)?>);
</script>
<!--<h1>:)</h1>-->

<p class="success" align="center"><?php echo($message); ?></p>

<?php }else{?>
<!--<script type="text/javascript">
	Showbo.Msg.alert(<?php echo ($error)?>);
</script>
<h1>:(</h1>-->
<p class="error" align="center"><?php echo($error); ?></p>
<?php }?>
<p class="detail"></p>
