...
define('APPKEY','CErmKdb6xO7qV2hJ9o0MQ5');
define('APPID','pQU1PpWli97vxbw8SSJNCA');
define('MASTERSECRET','V2GPxXpyom8o9BZSaC2UT4');
// define('CID','79b7424fbc73edae556014467e9229d1');
// define('DEVICETOKEN','f8e8b21d4790849b918f2a3eb14024789903464cf52af9fc9aa21bbff13d3088');

define('CID','ffc8663c99d1fe0e49ba7754ad9a3b0d');
define('DEVICETOKEN','149af5ec0c78712feebcdf544f721941b92531a8ed2ec58758fc311aa03ffa9c');
...
function pushMessageToApp(){
   ...
   // $cdt->addCondition(AppConditions::REGION, $provinceList);
    ...
    $rep = $igt->pushMessageToApp($message,"任务组名11");
...
function IGtTransmissionTemplateDemo(){
    ...
    $template->set_transmissionContent('{"type":2,"data":{"time":1466478836,"fromid":1,"targetid":1,"type":2,"info":{"id":21,"title":"\u66f4\u65b0\u901a\u77e5","content":"测试","image":"","url":""},"content":"测试"}}');//透传内容
    //$template->set_duration(BEGINTIME,ENDTIME); //设置ANDROID客户端在此时间区间内展示消息
    //APN简单推送
//        $template = new IGtAPNTemplate();
//        $apn = new IGtAPNPayload();
